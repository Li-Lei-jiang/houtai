    ...
    <div>
      ...
      >
        <div id="head">
          <div class="head-rig">
            <span>
              <el-button type="danger" @click="golooks">查看</el-button>
            </span>
            <span>
        ...
        <!--        标题-->
        <div>
          <el-form-item label="文章标题" prop="title" :required="true">
            <el-input
        ...
        <div id="potion">
          ...
          <!--      类目-->
          <div>
            <el-form-item label="类目" prop="category" :required="true">
              <el-select
          ...
          <!--          重要性-->
          <div>
            <el-form-item label="重要性" prop="star" :required="true">
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        source: [{ required: true, message: "请输入来源", trigger: "change" }], //来源
        star: [
          //重要性
  ...
  filters: {},
  computed: {
    // GXruleForm() {//这一步是获取到需要共享的数据然后 传过去
    //   return this.$store.GXruleForm;
    // }
  },
  watch: {},
  directives: {}
